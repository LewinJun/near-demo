...
let HelloNear = (_dec = NearBindgen({}), _dec2 = view(), _dec3 = call({}), _dec4 = view(), _dec5 = call({}), _dec(_class = (_class2 = class HelloNear {
  static schema = {
    greeting: 'string',
    books: 'object'
  };
  ...
  set_book({
    ...
    const aBooks = this.books[accountId] || [];
    // 获取当前区块时间戳，单位为纳秒
    const timestampNanoseconds = blockTimestamp();
...
}, _applyDecoratedDescriptor(_class2.prototype, "get_greeting", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "get_greeting"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_greeting", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "set_greeting"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_books", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "get_books"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_book", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "set_book"), _class2.prototype), _class2)) || _class);
function set_book() {
  ...
  const _result = _contract.set_book(_args);
...
function get_books() {
  ...
  const _args = HelloNear._getArgs();
  const _result = _contract.get_books(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(HelloNear._serialize(_result, true));
}
...
export { get_books, get_greeting, set_book, set_greeting };
//# sourceMappingURL=lewin1_near.js.map
